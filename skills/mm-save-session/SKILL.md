...
1. **Прогони Secret-Scan** по всем измененным/новым файлам перед добавлением в git (по логике Шага 3.5). Если обнаружен реальный секрет (Класс A), прерви автопуш, выведи предупреждение и не коммить.
