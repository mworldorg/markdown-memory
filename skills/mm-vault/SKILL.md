...
2. Прогони все файлы папки через регулярные выражения из `<repo>/docs/SECRET-PATTERNS.md`.
   - **Класс A (Высокоточные секреты):**
     ...
     - **Жди явного исправления/подтверждения** перед созданием репозитория. Не продолжай автоматически.
   - **Класс B (Широкие совпадения / предупреждения):**
     ...
     - Не блокируй выполнение, если это заведомые false positives (например, вики-ссылки Obsidian вида `[[sessions/2026-...]]`).
