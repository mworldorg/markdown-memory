...
Если в проекте разрабатывается Telegram-бот (в зависимости от флага `tg_bot_project` в паспорте или наличия бота в зависимостях):
...
⚠️ TG Bot UI/UX: <✅ OK | ⚠️ обнаружены отклонения от стандартов / отсутствует tg-bot-ui-ux.md | n/a если бот не разрабатывается>
